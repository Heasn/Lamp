...
{
    internal unsafe class AES
    {
        private readonly byte[][][] mW = new byte[11][][];
        ...
        public void* Cipher(void* input, void* output, int length)
        {
            byte* inByte = (byte*)input;
            byte* outByte = (byte*)output;
            int i;
            if (length <= 0)
            {
            ...
            {
                Cipher(inByte + i, outByte + i);
            }
            return output;
        }

        public void* InvCipher(void* input, void* output, int length)
        {
            byte* inByte = (byte*)input;
            byte* outByte = (byte*)output;
            int i;
